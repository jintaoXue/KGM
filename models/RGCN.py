...
class HeteroClassifier(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_classes, rel_names):
        ...
        self.lstm_agg = LSTMAggregator(input_size=300, hidden_size=512, max_len=45, num_layer=2, 
        out_size=300, bs=256, drop=0.1, cuda=True, bn=False, direction=True)
    ...
    def forward(self, g):
        ...
        batched_feats = (h['prod']).view(256*2, 45, 300)
