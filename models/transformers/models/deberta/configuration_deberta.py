...
class DebertaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        bert_dic = kwargs['bert_dic']
        self.hidden_size = bert_dic['hidden_size']
        self.num_hidden_layers = bert_dic['num_hidden_layers']
        self.num_attention_heads = bert_dic['num_attention_heads']
        self.intermediate_size = bert_dic['intermediate_size']
        self.hidden_act = bert_dic['hidden_act']
        self.hidden_dropout_prob = bert_dic['hidden_dropout_prob']
        self.attention_probs_dropout_prob = bert_dic['attention_probs_dropout_prob']
        self.max_position_embeddings = bert_dic['max_len'] #??? check this
        self.type_vocab_size = bert_dic['type_vocab_size']
        self.vocab_size = bert_dic['vocab_size']
        self.embedding_dim = bert_dic['embedding_dim']
        self.out_size = bert_dic['out_size']
        self.pad_token_id = bert_dic['PAD_id']
        self.relative_attention = bert_dic['relative_attention']
        
        self.initializer_range = initializer_range
        self.max_relative_positions = max_relative_positions
        self.position_biased_input = position_biased_input
        
        pos_att_type = bert_dic['att_type']
